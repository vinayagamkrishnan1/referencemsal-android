...
package com.eygsl.cbs.referencemsal.authentication;
...
public final class MSALUtil {
    ...
    public static void acquireToken(@NonNull final Activity fromActivity, @NonNull final String[] scopes,
        ...
        initializeMSALSingleClinet(fromActivity.getApplicationContext());
    ...
    private static synchronized void initializeMsalClientApplication(final Context appContext)
        ...
        if (mMsalClientApplication == null) {
            ...
            mMsalClientApplication = PublicClientApplication.create(appContext, R.raw.auth_config_single_account);
        }
    }

    private static synchronized void initializeMSALSingleClinet(final Context appContext) {
        PublicClientApplication.createSingleAccountPublicClientApplication(appContext,
                R.raw.auth_config_single_account,
                new IPublicClientApplication.ISingleAccountApplicationCreatedListener() {
                    @Override
                    public void onCreated(ISingleAccountPublicClientApplication application) {
                        Log.d("SINGLE", "ISingleAccountApplicationCreatedListener");
                        mSingleAccountApp = application;
                    }

                    @Override
                    public void onError(MsalException exception) {
                        Log.d("ERROR_WHILE_SINGLE", exception.getMessage());
                        Log.d("ERROR_WHILE_SINGLE", exception.getErrorCode());
                        Log.d("ERROR_WHILE_SINGLE", exception.toString());
                    }
                });
    }
